...
from .logger import logger, get_logger, get_log_file_path, read_recent_logs, LogSignal, write_crash_log, flush_log, PROGRAM_DIR, LOG_DIR
...
__all__ = [
    ...
    'write_crash_log', 'flush_log', 'PROGRAM_DIR', 'LOG_DIR',
    'DeTikZifyRecognizer', 'create_recognizer',
    'is_detikzify_available', 'get_detikzify_error',
    'DETIKZIFY_AVAILABLE',
]